PhluantAds = {
	...
	drawRotate: function(){
		...
		setTimeout(function(){
			...
			self.ctx.save();
			self.ctx.translate(self.config.x+self.config.width/4,self.config.y+self.config.height/4);
			self.ctx.rotate(self.arcRotate*Math.PI/180);
			self.ctx.drawImage(self.start0, 0, 0, self.config.width, self.config.height, -self.config.width/4, -self.config.height/4, self.config.width/2, self.config.height/2);
			self.ctx.stroke();
			self.ctx.restore();
	...
	drawTopEdge1: function(){
		...
		setTimeout(function(){
			...
			self.ctx.save();
			self.ctx.translate(self.config.x+self.config.width/4,self.config.y+self.config.height/4);
			self.ctx.drawImage(self.start1, self.start1_frame*self.config.height, 0, self.config.height, self.config.width, -self.config.height/4, -self.config.width/4, self.config.height/2, self.config.width/2);
			self.ctx.stroke();
			self.ctx.restore();
	...
	drawTopEdge2: function(){
		...
		setTimeout(function(){
			...
			self.ctx.save();
			self.ctx.translate(self.config.x+self.config.width/4,self.config.y+self.config.height/4);
			self.ctx.drawImage(self.start3, self.start3_frame*self.config.height, 0, self.config.height, self.config.width, -self.config.height/4, -self.config.width/4, self.config.height/2, self.config.width/2);
			self.ctx.stroke();
			self.ctx.restore();
	...
	drawBottomEdge1: function(){
		...
		setTimeout(function(){
			...
			self.ctx.save();
			self.ctx.translate(self.config.x+self.config.width/4,self.config.y+self.config.height/4);
			self.ctx.drawImage(self.start2, self.start2_frame*self.config.height, 0, self.config.height, self.config.width, -self.config.height/4, -self.config.width/4, self.config.height/2, self.config.width/2);
			self.ctx.stroke();
			self.ctx.restore();
	...
	drawBottomEdge2: function(){
		...
		setTimeout(function(){
			...
			self.ctx.save();
			self.ctx.translate(self.config.x+self.config.width/4,self.config.y+self.config.height/4);
			self.ctx.drawImage(self.start4, self.start4_frame*self.config.height, 0, self.config.height, self.config.width, -self.config.height/4, -self.config.width/4, self.config.height/2, self.config.width/2);
			self.ctx.stroke();
			self.ctx.restore();
	...
	drawFlyStart: function(){
		var self = this;
		var path = "M138.965,100.11c-6.86,2.421-61.335-4.684-64.064-9.688";
	...
	drawFlyOut: function(){
		var self = this;
		var path = "M74.901,90.421c-95.515-98.5,81.334-94.167,47.521-30.664,M122.421,59.758c-50.448,41.79,7.195-126.664,146.478-96.441";
	...
	drawFlyIn: function(){
		var self = this;
		var path = "M240.25-50c-26.13,15.679-56.133,186.445,2.018,137.197,M242.268,87.197c14.564-68.499-77.477,25.885-149.303,37.931";
