PhluantAds = {
	...
	drawRotate: function(){
		...
		setTimeout(function(){
			...
			self.ctx.save();
			self.ctx.translate(self.config.x+self.config.width/6,self.config.y+self.config.height/6);
			self.ctx.rotate(self.arcRotate*Math.PI/180);
			self.ctx.drawImage(self.start0, 0, 0, self.config.width, self.config.height, -self.config.width/6, -self.config.height/6, self.config.width/3, self.config.height/3);
			self.ctx.stroke();
			self.ctx.restore();
	...
	drawTopEdge1: function(){
		...
		setTimeout(function(){
			...
			self.ctx.save();
			self.ctx.translate(self.config.x+self.config.width/6,self.config.y+self.config.height/6);
			self.ctx.drawImage(self.start1, self.start1_frame*self.config.height, 0, self.config.height, self.config.width, -self.config.height/6, -self.config.width/6, self.config.height/3, self.config.width/3);
			self.ctx.stroke();
			self.ctx.restore();
	...
	drawTopEdge2: function(){
		...
		setTimeout(function(){
			...
			self.ctx.save();
			self.ctx.translate(self.config.x+self.config.width/6,self.config.y+self.config.height/6);
			self.ctx.drawImage(self.start3, self.start3_frame*self.config.height, 0, self.config.height, self.config.width, -self.config.height/6, -self.config.width/6, self.config.height/3, self.config.width/3);
			self.ctx.stroke();
			self.ctx.restore();
	...
	drawBottomEdge1: function(){
		...
		setTimeout(function(){
			...
			self.ctx.save();
			self.ctx.translate(self.config.x+self.config.width/6,self.config.y+self.config.height/6);
			self.ctx.drawImage(self.start2, self.start2_frame*self.config.height, 0, self.config.height, self.config.width, -self.config.height/6, -self.config.width/6, self.config.height/3, self.config.width/3);
			self.ctx.stroke();
			self.ctx.restore();
	...
	drawBottomEdge2: function(){
		...
		setTimeout(function(){
			...
			self.ctx.save();
			self.ctx.translate(self.config.x+self.config.width/6,self.config.y+self.config.height/6);
			self.ctx.drawImage(self.start4, self.start4_frame*self.config.height, 0, self.config.height, self.config.width, -self.config.height/6, -self.config.width/6, self.config.height/3, self.config.width/3);
			self.ctx.stroke();
			self.ctx.restore();
	...
	drawFlyStart: function(){
		var self = this;
		var path = "M533.907,21.125c-3.699-0.316-45.674,2.946-52.818,3.762";
	...
	drawFlyOut: function(){
		var self = this;
		var path = "M481.089,24.887c-42.839,3.197-234.045,36.328-220.779-1.22,M260.31,23.667c168.767-37.296-92.421,58.054-57.7-5.999,M202.61,17.668C217.699,9.413,290.097-55,299-55";
	...
	drawFlyIn: function(){
		var self = this;
		var path = "M153-96.667c70.353,298.223,275,78,146,129.217,M299,32.551c-52.123,54.449,221,7.892,261,0";
