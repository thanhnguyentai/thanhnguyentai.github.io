...
function slide(){
    ...
    $('#previous').bind('touchstart', function(){
        ...
        if(currProduct > 0){
            ...
            resetProduct();
            id = "productListImgContent";  
            transform2d(id, 1 , 0, -350*currProduct, 0,false,false, 0.5 ,'linear');
            ...
            */
            ...
            changeStyleProduct('#productItem'+currProduct);
            resetProduct();
            transform2d('productListImgContent', 1 , 0, 350, 0,false,false, 0.5 ,'linear');
            transform2d('lastImage', 1 , 0, 350, 0,false,false, 0.5 ,'linear');

            setTimeout(function(){
                transform2d('productListImgContent', 1 , 0, -350*currProduct, 0,false,false, 0 ,'linear');
    ...
    $('#next').bind('touchstart', function(){
        ...
        if(currProduct < (maxProduct - 1)){
            ...
            */
            ...
            changeStyleProduct('#productItem'+currProduct);
            resetProduct();
            transform2d('productListImgContent', 1 , 0, -350*maxProduct, 0,false,false, 0.5 ,'linear');
            transform2d('firstImage', 1 , 0, -350, 0,false,false, 0.5 ,'linear');
