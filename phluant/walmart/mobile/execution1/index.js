...
function init(){
    ...
    preload('img/product1.png');
    preload('img/product2_3.png');
    preload('img/product4.png');
    preload('img/product5.png');
...
function scroller(){
    var height = 30 * maxProduct;
    $('.scroller').css('width',height+'px');
    $('#productList').jScroll({
        hScroll: false,
        vScroll: true
    });
