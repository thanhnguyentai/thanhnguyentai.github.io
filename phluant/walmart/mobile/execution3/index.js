...
function resetProduct(){
    ...
    $(url+'productItem'+preClick).css('font-size', '14px');
...
function prepareAnimation(){
    if(!$.browser.msie){
        ...
        enableTranform('miniboy',0.5,'linear');
        enableTranform('next',0.5,'linear');
        enableTranform('previous',0.5,'linear');
        enableTranform('minilogo',0.5,'linear');
        enableTranform('minitap',0.5,'linear');
        enableTranform('minitext',0.5,'linear');
