...
function init(){
    ...
    preload('img/emailinput.png');
    preload('img/exe2_bg.jpg');
    preload('img/highlight.png');
    preload('img/koolaid.png');
    ...
    preload('img/product6.png');
    preload('img/product7.png');
    preload('img/product8.png');
    preload('img/product9.png');
    preload('img/product10.png');
...
function prepareEvent(){
    ...
    if(!$.browser.msie){
        ...
        $('#legal').click(function(){
            transform2d('legalContent', 1 , 0, 0, -390,false,false, 0.5 ,'linear');
        });
    }
    else{
        prepareEventIE();
...
function prepareEventIE(){
    ...
    $('#legal_close').click(function(){
        transform2dIE('legalContent',0,390,false,false,0.5);
    });
    $('#legal').click(function(){
        transform2dIE('legalContent',0,-390,false,false,0.5);
    });
...
function slide(){
    ...
    $('#previous').bind('touchstart', function(){
        ...
        if(currProduct > 0){
            currProduct--;
            $('#next').css('display','block');
            scroll.scrollToElement('#productItem'+currProduct,true);
            changeStyleProduct('#productItem'+currProduct);
            resetProduct();
            id = "productListImgContent";  
            transform2d(id, 1 , 0, -250*currProduct, 0,false,false, 0.5 ,'linear');
            ...
            */
            ...
            changeStyleProduct('#productItem'+currProduct);
            resetProduct();
            transform2d('productListImgContent', 1 , 0, 250, 0,false,false, 0.5 ,'linear');
            transform2d('lastImage', 1 , 0, 250, 0,false,false, 0.5 ,'linear');

            setTimeout(function(){
                transform2d('productListImgContent', 1 , 0, -250*currProduct, 0,false,false, 0 ,'linear');
    ...
    $('#next').bind('touchstart', function(){
        ...
        if(currProduct < (maxProduct - 1)){
            ...
            */
            ...
            changeStyleProduct('#productItem'+currProduct);
            resetProduct();
            transform2d('productListImgContent', 1 , 0, -250*maxProduct, 0,false,false, 0.5 ,'linear');
            transform2d('firstImage', 1 , 0, -250, 0,false,false, 0.5 ,'linear');
...
function prepareAnimationProduct(){
    var id='';
    for(var x =0; x<maxProduct; x++){
        id='productItemImg' + x;
        enableTranform(id,0.5,'linear');
    }
}
...
function startExpand(){
    ...
    setTimeout(function(){
        transform2d('strimmer',1,0,180,0,false,false,1,'linear');
    },3000);
}
...
function startExpandIE(){
    ...
    alreadyAnimationExpand = true;
    setTimeout(function(){
        transform2dIE('strimmer',180,0,false,false,1);
    },3000);
}
