 ...
 */ 
if(!window.numOnly)
	numOnly=function(g){isNaN(parseFloat(g))&&(g=g.replace(/[^0-9.-]/,""));return parseFloat(g)};
    ...
    var scroller = (function() {
        ...
        scroller.prototype = {
            ...
            handleEvent: function(e) {
            	if ($(this.el).attr('scroll-disabled') != undefined)
            		return;
        		switch(e.type) {
