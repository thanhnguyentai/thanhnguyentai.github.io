...
function start(){
	...
	setTimeout(function(){
		transform2dObject($('.slides').eq(0),1,0,-400,0,false,false,0.3,'linear');
		setTimeout(function(){
			transform2dObject($('.slides').eq(0),1,0,-300,0,false,false,0.3,'linear');
...
function showMap(){
	transform2d('container_all',1,0,-300,0,false,false,0.5,'ease-in-out'); 
