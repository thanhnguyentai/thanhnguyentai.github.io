...
function getWeather(lat, lng){
    ...
    $.ajax({
        ...
        success:function(res){
            ...
            //var temp = Math.round(data.forecast.time[0].temperature.eve - 273);
            //var tempF = Math.round(temp / 0.8);
            ...
            html += '<span class="item" style="color: #000;font-size: 14px;margin-bottom: 3px;font-weight: bold;">' + min +' &deg;F - ' + max +' &deg;<span>F</span>';
            html += '</span>';
            html += weather.type;
            html += '</span>';
