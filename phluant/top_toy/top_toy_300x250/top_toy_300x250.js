$(document).ready(function(){
	$("<img/>").attr("src","img/300X250_TopToyS_Logo.png").load(preload);
	$("<img/>").attr("src","img/300X250_TopToyS1.png").load(preload);
	$("<img/>").attr("src","img/300X250_TopToyS2.png").load(preload);
	$("<img/>").attr("src","img/300X250_TopToyS3.png").load(preload);
	prepare();
});
...
function startBanner2() {
	startTranslate('slide', -300, 0);
}
function startBanner3() {
	startTranslate('slide', -600, 0);
}
