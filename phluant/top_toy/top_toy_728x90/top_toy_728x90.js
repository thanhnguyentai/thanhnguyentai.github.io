$(document).ready(function(){
	$("<img/>").attr("src","img/728x90_TopToys_Logo.png").load(preload);
	$("<img/>").attr("src","img/728x90_TopToys1.png").load(preload);
	$("<img/>").attr("src","img/728x90_TopToys2.png").load(preload);
	$("<img/>").attr("src","img/728x90_TopToys3.png").load(preload);
	prepare();
});
...
function startBanner2() {
	startTranslate('slide', 0, -90);
}
function startBanner3() {
	startTranslate('slide', 0, -180);
}
