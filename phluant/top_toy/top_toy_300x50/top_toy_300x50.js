$(document).ready(function(){
	$("<img/>").attr("src","img/300x50_TopToys_Logo.png").load(preload);
	$("<img/>").attr("src","img/300x50_TopToys1.png").load(preload);
	$("<img/>").attr("src","img/300x50_TopToys2.png").load(preload);
	$("<img/>").attr("src","img/300x50_TopToys3.png").load(preload);
	prepare();
});
