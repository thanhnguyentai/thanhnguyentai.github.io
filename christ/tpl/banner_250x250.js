$(document).ready(function(){
	$("<img/>").attr("src","img/banner_250x250_bg.jpg").load(preload);
	$("<img/>").attr("src","img/banner_250x250_logo1.png").load(preload);
	$("<img/>").attr("src","img/banner_250x250_text1.png").load(preload);
	$("<img/>").attr("src","img/banner_250x250_text2.png").load(preload);
        $("<img/>").attr("src","img/banner_250x250_light1.png").load(preload);
        $("<img/>").attr("src","img/banner_250x250_light2.png").load(preload);
        $("<img/>").attr("src","img/banner_250x250_ticket1.png").load(preload);
        $("<img/>").attr("src","img/banner_250x250_ticket2.png").load(preload);
        $("<img/>").attr("src","img/banner_250x250_beam1.png").load(preload);
        $("<img/>").attr("src","img/banner_250x250_beam2.png").load(preload);
        $("<img/>").attr("src","img/banner_250x250_slide.png").load(preload);

	prepare();
});

function prepare(){
	enableTranformZoom('text1',1,50,170);
	enableTranformZoom('frame_ticket',1,50,85);
...
function start(){
	...
	var timeout4 = setTimeout(function(){
		zoomAnimation('text1',0.005,0.5,'linear');
