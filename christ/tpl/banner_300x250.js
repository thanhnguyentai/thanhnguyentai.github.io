$(document).ready(function(){
	$("<img/>").attr("src","img/banner_300x250_bg.jpg").load(preload);
	$("<img/>").attr("src","img/banner_300x250_logo1.png").load(preload);
	$("<img/>").attr("src","img/banner_300x250_text1.png").load(preload);
	$("<img/>").attr("src","img/banner_300x250_text2.png").load(preload);
        $("<img/>").attr("src","img/banner_300x250_light1.png").load(preload);
        $("<img/>").attr("src","img/banner_300x250_light2.png").load(preload);
        $("<img/>").attr("src","img/banner_300x250_ticket1.png").load(preload);
        $("<img/>").attr("src","img/banner_300x250_ticket2.png").load(preload);
        $("<img/>").attr("src","img/banner_300x250_beam1.png").load(preload);
        $("<img/>").attr("src","img/banner_300x250_beam2.png").load(preload);
        $("<img/>").attr("src","img/banner_300x250_slide.png").load(preload);
