$(document).ready(function(){
	...
	$("<img/>").attr("src","img_banner/479x630_01.png").load(preload);
	$("<img/>").attr("src","img_banner/479x630_02.png").load(preload);
	$("<img/>").attr("src","img_banner/479x630_03.png").load(preload);
});
