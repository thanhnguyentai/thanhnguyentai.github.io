$(document).ready(function(){
	...
	$("<img/>").attr("src","img_banner/228x233_01.png").load(preload);
	$("<img/>").attr("src","img_banner/228x233_02.png").load(preload);
	$("<img/>").attr("src","img_banner/228x233_03.png").load(preload);
});
