$(document).ready(function(){
	$("<img/>").attr("src","img_banner/479x233_ballloon.png").load(preload);	
	$("<img/>").attr("src","img_banner/479x233_bg.png").load(preload);
	$("<img/>").attr("src","img_banner/479x233_button.png").load(preload);
	$("<img/>").attr("src","img_banner/479x233_firsttext.png").load(preload);
	$("<img/>").attr("src","img_banner/479x233_lasttext.png").load(preload);
...
loaded = 0;
function prepare(){
	enableTranformZoom('text2',0.9,50,60);
