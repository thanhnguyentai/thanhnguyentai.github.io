$(document).ready(function(){
	$("<img/>").attr("src","img_banner/476x630_ballloon.png").load(preload);	
	$("<img/>").attr("src","img_banner/476x630_bg.png").load(preload);
	$("<img/>").attr("src","img_banner/476x630_button.png").load(preload);
	$("<img/>").attr("src","img_banner/476x630_firsttext.png").load(preload);
	$("<img/>").attr("src","img_banner/476x630_lasttext.png").load(preload);
