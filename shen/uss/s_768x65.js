$(document).ready(function(){
	$("<img/>").attr("src","img_banner/768x65_bg1.png").load(preload);
	$("<img/>").attr("src","img_banner/768x65_bg2.png").load(preload);
	$("<img/>").attr("src","img_banner/768x65_bg3.png").load(preload);
	$("<img/>").attr("src","img_banner/768x65_cr1.png").load(preload);
	$("<img/>").attr("src","img_banner/768x65_cr2.png").load(preload);
	$("<img/>").attr("src","img_banner/768x65_cr3.png").load(preload);
	$("<img/>").attr("src","img_banner/768x65_cr4.png").load(preload);
});
