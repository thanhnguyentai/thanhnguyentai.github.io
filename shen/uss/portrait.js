$(document).ready(function(){
	$("<img/>").attr("src","img/768x935_bg.png").load(preload);
	$("<img/>").attr("src","img/768x935_bt.png").load(preload);
	$("<img/>").attr("src","img/768x935_cr1.png").load(preload);
	$("<img/>").attr("src","img/768x935_cr2.png").load(preload);
	$("<img/>").attr("src","img/768x935_cr3.png").load(preload);
	$("<img/>").attr("src","img/768x935_cr4.png").load(preload);
	$("<img/>").attr("src","img/768x935_text.png").load(preload);
	$("<img/>").attr("src","img/768x935_footer.png").load(preload);
});
