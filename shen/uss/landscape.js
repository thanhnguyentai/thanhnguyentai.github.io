$(document).ready(function(){
	$("<img/>").attr("src","img/1024x678_bg.png").load(preload);
	$("<img/>").attr("src","img/1024x678_bt.png").load(preload);
	$("<img/>").attr("src","img/1024x678_cr1.png").load(preload);
	$("<img/>").attr("src","img/1024x678_cr2.png").load(preload);
	$("<img/>").attr("src","img/1024x678_cr3.png").load(preload);
	$("<img/>").attr("src","img/1024x678_cr4.png").load(preload);
	$("<img/>").attr("src","img/1024x678_text.png").load(preload);
	$("<img/>").attr("src","img/1024x678_footer.png").load(preload);
});
