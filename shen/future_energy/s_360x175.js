$(document).ready(function(){
	$("<img/>").attr("src","img_banner/360x175_logo.png").load(preload);
	$("<img/>").attr("src","img_banner/360x175_text1.png").load(preload);
	$("<img/>").attr("src","img_banner/360x175_text2.png").load(preload);
});
