$(document).ready(function(){
	$("<img/>").attr("src","img_banner/768x65_logo.png").load(preload);
	$("<img/>").attr("src","img_banner/768x65_text1.png").load(preload);
	$("<img/>").attr("src","img_banner/768x65_text2.png").load(preload);
});
