$(document).ready(function(){
	$("<img/>").attr("src","img_banner/476x630_bg.jpg").load(preload);
	$("<img/>").attr("src","img_banner/476x630_len.png").load(preload);
	
	$("<img/>").attr("src","img_banner/476x630_artist5.png").load(preload);
	$("<img/>").attr("src","img_banner/476x630_artist4.png").load(preload);
	$("<img/>").attr("src","img_banner/476x630_artist3.png").load(preload);
	$("<img/>").attr("src","img_banner/476x630_artist2.png").load(preload);
	$("<img/>").attr("src","img_banner/476x630_artist1.png").load(preload);
	
	$("<img/>").attr("src","img_banner/476x630_text.png").load(preload);
	
	$("<img/>").attr("src","img_banner/476x630_sight1.png").load(preload);
	$("<img/>").attr("src","img_banner/476x630_sight2.png").load(preload);
	$("<img/>").attr("src","img_banner/476x630_sight3.png").load(preload);
	
	$("<img/>").attr("src","img_banner/476x630_text2.png").load(preload);
	$("<img/>").attr("src","img_banner/476x630_text3.png").load(preload);
	$("<img/>").attr("src","img_banner/476x630_findout.png").load(preload);
...
function dropArtist(){
	...
	var timeout = setTimeout(function(){
		...
		startTranslate('artist'+arrArtist[random],0,400);
...
function dropSight(){
	...
	var timeout = setTimeout(function(){
		...
		startTranslate('sight'+arraySight[random],0,500);
