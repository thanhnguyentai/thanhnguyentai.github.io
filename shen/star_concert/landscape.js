...
$(document).ready(function(){
	$("<img/>").attr("src","img/landscape_bg0.jpg").load(preload);
	$("<img/>").attr("src","img/landscape_bg1.jpg").load(preload);
	$("<img/>").attr("src","img/lens-flare.png").load(preload);
	$("<img/>").attr("src","img/landscape_lenflare.png").load(preload);
	$("<img/>").attr("src","img/landscape_frametop_bottom.png").load(preload);
	$("<img/>").attr("src","img/landscape_frametop_top.png").load(preload);
	$("<img/>").attr("src","img/landscape_signup.png").load(preload);
	$("<img/>").attr("src","img/landscape_start.png").load(preload);
	$("<img/>").attr("src","img/landscape_tab.png").load(preload);
	$("<img/>").attr("src","img/tab_view.png").load(preload);
	$("<img/>").attr("src","img/landscape_logo.png").load(preload);
	$("<img/>").attr("src","img/landscape_toptext.png").load(preload);
	$("<img/>").attr("src","img/landscape_bottomtext.png").load(preload);
...
arrPosition.push({x:534,y:330,z:3,zoom:0.8});
arrPosition.push({x:714,y:235,z:2,zoom:0.65});
arrPosition.push({x:620,y:160,z:1,zoom:0.52});
arrPosition.push({x:445,y:160,z:1,zoom:0.52});
arrPosition.push({x:344,y:240,z:2,zoom:0.65});
...
function registerViewArtist(){
	...
	$('.artist').click(function(){
		...
		$('#artist_landscape').attr('src','img/'+id+'_image.jpg');
	...
	$('#artist_landscape').click(function(){
		viewVideo();
	});
