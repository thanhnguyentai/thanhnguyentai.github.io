$(document).ready(function(){
	...
	$("<img/>").attr("src","img_banner/479x233_len.png").load(preload);
	
	$("<img/>").attr("src","img_banner/479x233_artist5.png").load(preload);
	$("<img/>").attr("src","img_banner/479x233_artist4.png").load(preload);
	$("<img/>").attr("src","img_banner/479x233_artist3.png").load(preload);
	$("<img/>").attr("src","img_banner/479x233_artist2.png").load(preload);
	$("<img/>").attr("src","img_banner/479x233_artist1.png").load(preload);
	
	$("<img/>").attr("src","img_banner/479x233_text.png").load(preload);
	
	$("<img/>").attr("src","img_banner/479x233_sight1.png").load(preload);
	$("<img/>").attr("src","img_banner/479x233_sight2.png").load(preload);
	$("<img/>").attr("src","img_banner/479x233_sight3.png").load(preload);
	
	$("<img/>").attr("src","img_banner/479x233_text2.png").load(preload);
	$("<img/>").attr("src","img_banner/479x233_text3.png").load(preload);
	$("<img/>").attr("src","img_banner/479x233_findout.png").load(preload);
...
function dropArtist(){
	...
	var timeout = setTimeout(function(){
		...
		startTranslate('artist'+arrArtist[random],0,200);
...
function dropSight(){
	...
	var timeout = setTimeout(function(){
		...
		startTranslate('sight'+arraySight[random],0,200);
