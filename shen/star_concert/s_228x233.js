$(document).ready(function(){
	...
	$("<img/>").attr("src","img_banner/228x233_len.png").load(preload);
	
	$("<img/>").attr("src","img_banner/228x233_artist5.png").load(preload);
	$("<img/>").attr("src","img_banner/228x233_artist4.png").load(preload);
	$("<img/>").attr("src","img_banner/228x233_artist3.png").load(preload);
	$("<img/>").attr("src","img_banner/228x233_artist2.png").load(preload);
	$("<img/>").attr("src","img_banner/228x233_artist1.png").load(preload);
	
	$("<img/>").attr("src","img_banner/228x233_text.png").load(preload);
	
	$("<img/>").attr("src","img_banner/228x233_sight1.png").load(preload);
	$("<img/>").attr("src","img_banner/228x233_sight2.png").load(preload);
	$("<img/>").attr("src","img_banner/228x233_sight3.png").load(preload);
	
	$("<img/>").attr("src","img_banner/228x233_text2.png").load(preload);
	$("<img/>").attr("src","img_banner/228x233_text3.png").load(preload);
	$("<img/>").attr("src","img_banner/228x233_findout.png").load(preload);
...
function flash(){
	...
	var timeout = setTimeout(function(){
		...
		fadeInImg('len'+arrLen[random],0.1);
