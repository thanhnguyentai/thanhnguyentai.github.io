$(document).ready(function(){
	...
	$("<img/>").attr("src","img_banner/476x630_bt1.jpg").load(preload);
	$("<img/>").attr("src","img_banner/476x630_bt2.jpg").load(preload);
	$("<img/>").attr("src","img_banner/476x630_bt3.jpg").load(preload);
	$("<img/>").attr("src","img_banner/476x630_text1.jpg").load(preload);
});
