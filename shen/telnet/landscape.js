$(document).ready(function(){
	$("<img/>").attr("src","img/ls_big_img.png").load(preload);
	$("<img/>").attr("src","img/ls_appstore.png").load(preload);
	$("<img/>").attr("src","img/ls_back.png").load(preload);
	$("<img/>").attr("src","img/ls_bigbt.png").load(preload);
	$("<img/>").attr("src","img/ls_bigbt_bag.png").load(preload);
	$("<img/>").attr("src","img/ls_bigbt_text.png").load(preload);
	$("<img/>").attr("src","img/ls_brown_bag.png").load(preload);
	$("<img/>").attr("src","img/ls_bt1.png").load(preload);
	$("<img/>").attr("src","img/ls_bt1_1.png").load(preload);
	$("<img/>").attr("src","img/ls_bt2.png").load(preload);
	$("<img/>").attr("src","img/ls_bt2_1.png").load(preload);
	$("<img/>").attr("src","img/ls_car.png").load(preload);
	$("<img/>").attr("src","img/ls_color_bag.png").load(preload);
	$("<img/>").attr("src","img/ls_diano.png").load(preload);
	$("<img/>").attr("src","img/ls_elephant.png").load(preload);
	$("<img/>").attr("src","img/ls_footer.png").load(preload);
	$("<img/>").attr("src","img/ls_frame_text.png").load(preload);
	$("<img/>").attr("src","img/ls_frame1_text.png").load(preload);
	$("<img/>").attr("src","img/ls_frame1_text1.png").load(preload);
	$("<img/>").attr("src","img/ls_frame2_bg.png").load(preload);
	$("<img/>").attr("src","img/ls_frame3_bg.png").load(preload);
	$("<img/>").attr("src","img/ls_frame3_leg.png").load(preload);
	$("<img/>").attr("src","img/ls_frame3_logo.png").load(preload);
	$("<img/>").attr("src","img/ls_frame3_shark.png").load(preload);
	$("<img/>").attr("src","img/ls_frame3_text1.png").load(preload);
	$("<img/>").attr("src","img/ls_frame3_text2.png").load(preload);
	$("<img/>").attr("src","img/ls_giraff.png").load(preload);
	$("<img/>").attr("src","img/ls_lion.png").load(preload);
	$("<img/>").attr("src","img/ls_red_bag.png").load(preload);
	$("<img/>").attr("src","img/ls_frame4_toy.png").load(preload);
	$("<img/>").attr("src","img/ls_frame4_bg.png").load(preload);
	$("<img/>").attr("src","img/ls_frame4_dragon.png").load(preload);
	$("<img/>").attr("src","img/ls_frame4_flame.png").load(preload);
	$("<img/>").attr("src","img/ls_frame4_logo.png").load(preload);
	$("<img/>").attr("src","img/ls_frame4_text1.png").load(preload);
	$("<img/>").attr("src","img/ls_frame4_text2.png").load(preload);
