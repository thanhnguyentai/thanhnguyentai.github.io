$(document).ready(function(){
	...
	$("<img/>").attr("src","img_banner/288x233_1.png").load(preload);	
	$("<img/>").attr("src","img_banner/288x233_2.png").load(preload);	
	$("<img/>").attr("src","img_banner/288x233_3.png").load(preload);	
	$("<img/>").attr("src","img_banner/288x233_4.png").load(preload);
