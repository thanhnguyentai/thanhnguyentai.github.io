$(document).ready(function(){
	prepare();
	$("<img/>").attr("src","img/banner_468x60_bg.png").load(preload);
	$("<img/>").attr("src","img/banner_468x60_facebooklight_down.png").load(preload);
	$("<img/>").attr("src","img/banner_468x60_facebook.png").load(preload);
	$("<img/>").attr("src","img/banner_468x60_facebooklight_up.png").load(preload);
	$("<img/>").attr("src","img/banner_468x60_twitterlight_down.png").load(preload);
	$("<img/>").attr("src","img/banner_468x60_twitter.png").load(preload);
	$("<img/>").attr("src","img/banner_468x60_twitterlight_up.png").load(preload);
	$("<img/>").attr("src","img/banner_468x60_text1.png").load(preload);
	$("<img/>").attr("src","img/banner_468x60_winlight.png").load(preload);
	$("<img/>").attr("src","img/banner_468x60_text3.png").load(preload);
	$("<img/>").attr("src","img/banner_468x60_text2_blur.png").load(preload);
	$("<img/>").attr("src","img/banner_468x60_text2.png").load(preload);
	$("<img/>").attr("src","img/banner_468x60_text4.png").load(preload);
	$("<img/>").attr("src","img/banner_468x60_circle_down.png").load(preload);
	$("<img/>").attr("src","img/banner_468x60_planet.png").load(preload);
	$("<img/>").attr("src","img/banner_468x60_circle_up.png").load(preload);
	$("<img/>").attr("src","img/banner_468x60_win.png").load(preload);
	$("<img/>").attr("src","img/banner_468x60_twitter.png").load(preload);
	$("<img/>").attr("src","img/banner_468x60_facebook.png").load(preload);
	$("<img/>").attr("src","img/banner_468x60_logo.png").load(preload);
...
function prepare(){
	...
	enableTranformZoom('facebook_frame',1,10,30);
...
function start(){
	...
	runCircleDown('facebookbig',0,0,2,2,-1);	
	runCircleDown('twitterbig',0,0,2,2,-1);
	runCircleUp('winball',0,0,5,5,1);
	*/
	...
	var timeout3 = setTimeout(function(){
		...
		var timeout4 = setTimeout(function(){
			...
			var timeout5 = setTimeout(function(){
				zoomAnimation('facebook_frame',0.3,1,'linear')
				fadeOutImg('facebook_frame',1.5);
				...
				var timeout6 = setTimeout(function(){
					...
					var timeout10 = setTimeout(function(){
						...
						var timeout12 = setTimeout(function(){
							startTranslate('winlight_frame',-150,0);
							...
							var startRotateWinner = setTimeout(function(){
								runCircleUp('winball',0,0,5,5,1);
								clearTimeout(startRotateWinner);
							},900);
...
function runCircleUp(id,currentx,currenty,count,startCount,type){	
	...
	zoomAndTranslate(id,1,0.15,currentx,currenty,'linear');
	var timeout = setTimeout(function(){
			currentx += 15;
			switch(count){
				case 0:
...
function runCircleDown(id,currentx,currenty,count,startCount,type){
	...
	zoomAndTranslate(id,0.6,0.15,currentx,currenty,'linear');
