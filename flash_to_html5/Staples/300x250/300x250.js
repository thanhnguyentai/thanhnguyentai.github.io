...
function rotateImg(){
	...
	var timeTotal = 0;
	 ...
	 var time4 = setTimeout(function(){
		 	transform2d('red1',1,0,0,0,false,false,1.5*timeRotate,'linear',0,100);
			transform2d('red2',1,0,0,0,false,false,1.5*timeRotate,'linear',100,100);
			transform2d('red3',1,0,0,0,false,false,1.5*timeRotate,'linear',0,0);
			transform2d('red4',1,0,0,0,false,false,1.5*timeRotate,'linear',100,0);
	        clearTimeout(time4);
	 },timeTotal+timeDelay);
