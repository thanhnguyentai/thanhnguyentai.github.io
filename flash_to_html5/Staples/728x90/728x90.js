...
function prepareAnimation(){
    enableTransform2d('blue1',1,90,100,0,0,'linear');
    enableTransform2d('yellow1',1,90,100,0,0,'linear');
    enableTransform2d('green1',1,90,100,0,0,'linear');
    enableTransform2d('red1',1,90,100,0,0,'linear');
    
    
    enableTransform2d('blue2',1,-90,0,0,0,'linear'); 
    enableTransform2d('yellow2',1,-90,0,0,0,'linear');
    enableTransform2d('green2',1,-90,0,0,0,'linear');
    enableTransform2d('red2',1,-90,0,0,0,'linear');
    
    enableTransform2d('blue3',1,-90,100,100,0,'linear');
    enableTransform2d('yellow3',1,-90,100,100,0,'linear');
    enableTransform2d('green3',1,-90,100,100,0,'linear');
    enableTransform2d('red3',1,-90,100,100,0,'linear');
    
    enableTransform2d('blue4',1,90,0,100,0,'linear');
    enableTransform2d('yellow4',1,90,0,100,0,'linear');
    enableTransform2d('green4',1,90,0,100,0,'linear');
    enableTransform2d('red4',1,90,0,100,0,'linear');
...
function rotateImg(){
	...
	var timeTotal = 0;
	 var time1 = setTimeout(function(){
		 	transform2d('blue1',1,0,0,0,false,false,timeRotate,'linear',100,0);
			transform2d('blue2',1,0,0,0,false,false,timeRotate,'linear',0,0);
			transform2d('blue3',1,0,0,0,false,false,timeRotate,'linear',100,100);
			transform2d('blue4',1,0,0,0,false,false,timeRotate,'linear',0,100);
	        clearTimeout(time1);
	    },timeTotal);
	 
	 var time2 = setTimeout(function(){
		 	transform2d('yellow1',1,0,0,0,false,false,timeRotate,'linear',100,0);
			transform2d('yellow2',1,0,0,0,false,false,timeRotate,'linear',0,0);
			transform2d('yellow3',1,0,0,0,false,false,timeRotate,'linear',100,100);
			transform2d('yellow4',1,0,0,0,false,false,timeRotate,'linear',0,100);
	        clearTimeout(time2);
	 },timeTotal+timeDelay);
	 timeTotal += timeDelay;
	 var time3 = setTimeout(function(){
		 	transform2d('green1',1,0,0,0,false,false,timeRotate,'linear',100,0);
			transform2d('green2',1,0,0,0,false,false,timeRotate,'linear',0,0);
			transform2d('green3',1,0,0,0,false,false,timeRotate,'linear',100,100);
			transform2d('green4',1,0,0,0,false,false,timeRotate,'linear',0,100);
	        clearTimeout(time3);
	 },timeTotal+timeDelay);
	 timeTotal += timeDelay;
	 
	 var time4 = setTimeout(function(){
		 	transform2d('red1',1,0,0,0,false,false,timeRotate,'linear',100,0);
			transform2d('red2',1,0,0,0,false,false,timeRotate,'linear',0,0);
			transform2d('red3',1,0,0,0,false,false,timeRotate,'linear',100,100);
			transform2d('red4',1,0,0,0,false,false,timeRotate,'linear',0,100);
	        clearTimeout(time4);
	 },timeTotal+timeDelay);
	 timeTotal += timeDelay;
